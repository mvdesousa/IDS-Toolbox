<style>
	...
	body {
		background:url('images/bg/brickwall.png') repeat;
	}
		...
		<div class="register-form">
			...
			<div class="formGroup">
				...
				<form id="registerForm" class="col-md-12 hidethis" action="registerAccount.php" method="POST">
					...
					<input id="register_username" type="text" name="register_username" placeholder="username" value=""/></p>

					<p><label for="register_password" class="unselectable">Password</label>
					<input id="register_password" type="password" name="register_password" placeholder="password" value=""/></p>

					<p><label for="register_cpassword" class="unselectable">Confirm Password</label>
					<input id="register_cpassword" type="password" name="register_cpassword" placeholder="password" value=""/></p>
					...
					<input id="register_position" type="text" name="register_position" placeholder="Web Developer" value=""/></p>
