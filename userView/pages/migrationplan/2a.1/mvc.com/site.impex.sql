#
# Import the CMS Site configuration for the MarriottVacationClub.com site
#
$productCatalog=MarriottVacationClub.comProductCatalog
$contentCatalog=MarriottVacationClub.comContentCatalog
$contentCV=catalogVersion(CatalogVersion.catalog(Catalog.id[default=$contentCatalog]),CatalogVersion.version[default=Staged])[default=$contentCatalog:Staged]
$defaultLanguage=en
$storeUid=MarriottVacationClub.com
$siteUid=MarriottVacationClub.com
...
# CMS Site
INSERT_UPDATE CMSSite;uid[unique=true];theme(code);channel(code);stores(uid);contentCatalogs(id);defaultCatalog(id);defaultLanguage(isoCode);siteMapConfig(&siteMapConfigId);urlPatterns;active;previewURL;startingPage(uid,$contentCV);urlEncodingAttributes;defaultPromotionGroup(Identifier)[default=MarriottVacationClub.comPromoGrp]
