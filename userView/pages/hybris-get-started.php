...
<div class="zero-clipboard"><span class="btn-clipboard" data-clipboard-target="clipboard-files">Copy</span></div>
  <pre id="clipboard-files"><code class="language-directory">
hybris/
├── bin/
│   ├── platform/
│       ├── setantenv.bat
│       ├── hybrisserver.bat
├── config/
│   └── (Only for reference. This is generated after calling 'ant clean all')
│       ├── folder/
│       ├── folder/
│       ├── folder/
├── log/
...
<div class="zero-clipboard"><span class="btn-clipboard" data-clipboard-target="clipboard-text">Copy</span></div>
  <pre data-src="/pages/examples/invoice.html"></pre>
