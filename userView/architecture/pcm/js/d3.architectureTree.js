    ...
    var updateData = function(container, nodes, links) {
        ...
        node.append("circle")
            ...
            .style('stroke', function(d) {
            		if (typeof d.hybrismigration === "undefined") return '#0080C0';
            		if (d.hybrismigration === "1") return '#0080C0';
            		if (d.hybrismigration === "100") return '#008040';
                return d3.scale.linear()
                    .domain([100, 0])
                    .range(["red", "orange"])(typeof d.hybrismigration !== "undefined" ? d.hybrismigration : 1);
            })
            .style('fill', function(d) {
                if (typeof d.hybrismigration === "undefined") return '#fff';
            		if (d.hybrismigration === "100") return '#008040';
                return d3.scale.linear()
                    .domain([100, 0])
                    .range(["red", "white"])(typeof d.hybrismigration !== "undefined" ? d.hybrismigration : 1);
            });
