      ...
      <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
          Questions? <a href="mailto:brandon.bartlett@vacationclub.com">brandon.bartlett@vacationclub.com</a>
        </div>
        <!-- Default to the left -->
        <strong>hybris Migration.
      </footer>
      ...
      <aside class="control-sidebar control-sidebar-dark">                
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
          ...
          <li><a href="#control-sidebar-stats-tab" data-toggle="tab"><i class="fa fa-rocket"></i></a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="control-sidebar-home-tab">
            ...
            <ul class='control-sidebar-menu'>
              <li>
                <a href='javascript::;'>               
                  <h6 class="control-sidebar-subheading">
    ...
    <!-- DATA TABLES SCRIPT -->
    <script src="/IDS-Toolbox/userView//plugins/datatables/jquery.dataTables.js" type="text/javascript"></script>
    <script src="/IDS-Toolbox/userView//plugins/datatables/dataTables.bootstrap.js" type="text/javascript"></script>
